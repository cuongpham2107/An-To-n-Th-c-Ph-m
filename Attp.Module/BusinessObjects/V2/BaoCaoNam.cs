...
namespace Attp.Module.BusinessObjects.V2
{
    ...
    public class KyBaoCaoNam : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        // Use CodeRush to create XPO classes and properties with a few keystrokes.
        // https://docs.devexpress.com/CodeRushForRoslyn/118557
        public KyBaoCaoNam(Session session)
            : base(session)
        {
        }
		...
		{
			var item = Session.Query<KyBaoCaoNam>().Count(i => i.Nam == Nam && i.Oid != Oid);
			if (item >= 1)
			{
        ...
        #region Associations
  //      [Association("KyBaoCaoNam-KetQuaThamDinhCSSXs")]
  ...
  //      [Association("KyBaoCaoNam-KetQuaThanhKiemTraCSSXs")]
  ...
  //      [Association("KyBaoCaoNam-GiayChungNhanATTPs")]
  ...
  //      [Association("KyBaoCaoNam-DuLieuKiemTraCSSXs")]
		//[ModelDefault("AllowEdit", "False")]
